...
<script type="text/javascript">
    ...
    function initPagination() {
        ...
        const properties = {
            ...
            items_per_page: ${requestScope.pageInfo.pageSize},        // 每页显示记录数
            current_page: ${requestScope.pageInfo.pageNum - 1},      // Pagination内部使用pageIndex来管理页码，pageIndex从0开始，而pageNum从1开始
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="<c:url value="/admin/get/page"/>" method="post" class="form-inline" role="form"
                          style="float:left;">
                    ...
                    <a href="<c:url value="/admin/toAddPage"/>" class="btn btn-primary" style="float:right;"><i
